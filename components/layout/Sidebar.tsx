...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden md:flex md:w-64 flex-col fixed inset-y-0 z-40 bg-white border-r border-neutral-200">
      {/* Brand Header */}
      <div className="h-16 flex items-center gap-3 px-6 border-b border-neutral-200">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-brand-700 via-brand-600 to-indigo-500 flex items-center justify-center text-white font-bold shadow-md shadow-brand-500/20">
          <span className="text-base tracking-tight font-mono">₹</span>
        </div>
        <div>
      ...
      {/* Sidebar Footer / Compliance Tag */}
      <div className="p-4 border-t border-neutral-200 bg-neutral-50/60">
        <div className="rounded-xl p-3 bg-white border border-neutral-200 shadow-sm space-y-2">
